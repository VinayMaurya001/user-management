...
public class JwtTokenProvider {
	...
	public  static final CopyOnWriteArrayList<String> loggedTokenList=new CopyOnWriteArrayList<>();
	...
	public String resolveToken(HttpServletRequest request) {
		...
		String token = bearerToken==null?null:bearerToken.substring(7, bearerToken.length());
		if(!loggedTokenList.contains( token)){
			return null;
		}
